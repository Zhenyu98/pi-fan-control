...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--zone-low", type=float, default=50.0, help="Zone MPC lower comfort bound in Celsius")
    parser.add_argument("--zone-high", type=float, default=60.0, help="Zone MPC upper comfort bound in Celsius")
